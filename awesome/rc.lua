...
root.buttons(mytable.join(
	...
	--Commented out to disable mousewheel from toggling tag
...
globalkeys = mytable.join(
	...
	end, { descripton = "Take a screenshot", group = "hotkeys" }),

	-- Open volume control
	awful.key({ modkey }, "v", function()
		awful.spawn(volctl)
	end, { description = "Open volume control", group = "hotkeys" }),
	...
	-- Show help
	awful.key({ modkey }, "s", hotkeys_popup.show_help, { description = "Show Awesome help", group = "awesome" }),
	...
	awful.key({}, "XF86AudioRaiseVolume", function()
		awful.spawn.easy_async_with_shell(
			'amixer get Master | tail -2 | grep -c "off"',
	...
	end, { description = "Rhythmbox track info", group = "hotkeys" }),
	...
	awful.key({}, "XF86AudioPlay", function()
		os.execute("rhythmbox-client --play-pause")
	end, { description = "Rhythmbox play/pause", group = "hotkeys" }),

	awful.key({}, "XF86AudioPrev", function()
		os.execute("rhythmbox-client --no-start --previous")
	end, { description = "Rhythmbox previous track", group = "hotkeys" }),

	awful.key({}, "XF86AudioNext", function()
		os.execute("rhythmbox-client --no-start --next")
	end, { description = "Rhythmbox previous track", group = "hotkeys" }),
	...
	end, { description = "Graphical file manager", group = "launcher" }),
	...
	awful.key({ modkey, "Shift" }, "p", function()
		awful.spawn.with_shell("jk-power.sh")
	...
	-- MAKE SURE LAST ENTRY HAS NO COMMA BEHIND IT
)
